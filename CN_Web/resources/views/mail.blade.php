...
<div class="wrapper centered">
  <article class="letter">
    <div class="side">
      ...
      <p>
        <textarea placeholder="Your message" name="massage"></textarea>
      </p>
    </div>
    <div class="side">
      <p>
        <input type="text" placeholder="to" class ="typeahead form-controll" name="to" required>
      </p>
      <p>
      ...
      <a href="index">Quay trở lại trang chủ</a>
    </div>
  </form>
  </article>
